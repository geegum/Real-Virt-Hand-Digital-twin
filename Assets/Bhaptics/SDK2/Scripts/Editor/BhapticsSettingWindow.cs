...
namespace Bhaptics.SDK2.Editor
{
    public class BhapticsSettingWindow : EditorWindow
    {
        ...
        private const string UnityHowToStartUrl = "https://docs.bhaptics.com/sdk/unity/guide";
        private const string UnityMigrateUrl = "https://docs.bhaptics.com/sdk/unity/migration/1";
