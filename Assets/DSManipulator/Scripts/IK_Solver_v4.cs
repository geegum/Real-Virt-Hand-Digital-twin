...
//rotation문제 해결
//rotation을 따라감으로써 오히려 singularity가 늘어난 느낌...

public class IK_Solver_v4 : MonoBehaviour
{
    ...
    void SolveIK()
    {
        for (int iteration = 0; iteration < maxIterations; iteration++)
        {
            ...
            Vector<double> jointVelocities = DampedLeastSquares(jacobian, positionError, rotationError, 0.1f); // 감쇠율을 높임
