...
public class Impedance_Control2 : MonoBehaviour
{
    ...
    void SolveIK()
    {
        for (int iteration = 0; iteration < maxIterations; iteration++)
        {
            ...
            Vector<double> jointVelocities = DLSWithFixedDamping(jacobian, positionError, rotationError);
    ...
    Vector<double> DLSWithFixedDamping(Matrix<double> jacobian, Vector<double> positionError, Vector<double> rotationError)
    {
        var svd = jacobian.Svd();
